...
A video, audio, and image compressor built with Rust and Tauri.

<p align="center">
  <img src="icon.png" width="128" alt="BlubberBound"/>
</p>
...
- 🔄 **In-App Updates** - Choose stable, beta, or alpha builds
...
BlubberBound is licensed under the [GNU General Public License v3.0](LICENSE).

You may use, modify, and redistribute it. Distributed modified versions must
remain under the GPL with their source available.

FFmpeg is bundled with Windows builds. See [third-party notices](THIRD_PARTY_NOTICES.md).
